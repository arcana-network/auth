...
const ChainList: Record<Chains, RpcConfig> = {
...
export const getConfigFromChain = (c: Chains): RpcConfig => {
  if (ChainList[c]) {
    return ChainList[c]
  } else {
